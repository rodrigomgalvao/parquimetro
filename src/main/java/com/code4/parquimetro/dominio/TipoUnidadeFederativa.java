...
public enum TipoUnidadeFederativa {
     ...
     */
    TipoUnidadeFederativa(final String nome, final String sigla, final String capital) {
        this.nome = nome;
        this.sigla = sigla;
     ...
     */
    public static TipoUnidadeFederativa fromUF(final String nomeUf) {
        for (final TipoUnidadeFederativa uf : TipoUnidadeFederativa.values()) {
     ...
     */
    public static TipoUnidadeFederativa fromSigla(final String sigla) {
        for (final TipoUnidadeFederativa uf : TipoUnidadeFederativa.values()) {
     ...
     */
    public static TipoUnidadeFederativa fromCapital(final String capital) {
        for (final TipoUnidadeFederativa uf : TipoUnidadeFederativa.values()) {
